 ...
 *
 * Copyright:
 *   Copyright (c) University of Dundee, 2001-2017
 *
 * Language:
 *   ANSI C
 *
...
/* Work-around for missing snprintf() on VisualStudio 2013 and older. */
#if defined(_MSC_VER) && _MSC_VER < 1900
/*
 * NOTE: _snprintf() will NOT terminate the buffer if the text is too long
 * so you MUST manually terminate it afterwards. See Format::f() etc.
 */
